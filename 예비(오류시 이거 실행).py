...
enemy1_size = enemy.get_rect().size 
...
enemy2_y_pos = -enemy1_height
enemy2_speed=0.3

#적3 만들기
enemy3=pygame.image.load(ddong)
enemy3_size = enemy.get_rect().size 
enemy3_width = enemy3_size[0] 
enemy3_height = enemy3_size[1] 
enemy3_x_pos = random.randint(0, screen_width-enemy3_width)
enemy3_y_pos = -enemy1_height
enemy3_speed=0.9

#적4 만들기
enemy4=pygame.image.load(ddong)
enemy4_size = enemy.get_rect().size 
enemy4_width = enemy4_size[0] 
enemy4_height = enemy4_size[1] 
enemy4_x_pos = random.randint(0, screen_width-enemy4_width)
enemy4_y_pos =-enemy1_height
enemy4_speed=0.155

#적5 만들기
enemy5=pygame.image.load(ddong)
enemy5_size = enemy.get_rect().size 
enemy5_width = enemy5_size[0] 
enemy5_height = enemy5_size[1] 
enemy5_x_pos = random.randint(0, screen_width-enemy5_width)
enemy5_y_pos =-enemy1_height
enemy5_speed=1.5
...
#하트 만들기
heart= pygame.image.load("C:\\Users\\goldc\\Desktop\\민준이꺼\\python\\동아리 과제.py\\운석 피하기 게임\\하트.png")
heart1=pygame.image.load("C:\\Users\\goldc\\Desktop\\민준이꺼\\python\\동아리 과제.py\\운석 피하기 게임\\하트.png")
heart2=pygame.image.load("C:\\Users\\goldc\\Desktop\\민준이꺼\\python\\동아리 과제.py\\운석 피하기 게임\\하트.png")
heart_score=3
...
#게임 시작    
    ...
    #게임 캐릭터 위치 정의
        ...
        if score + elpased_score >= 1000:
            enemy4_y_pos += enemy4_speed*dt
        
        if score + elpased_score >= 2000:
        ...
        if character_rect.colliderect(enemy_rect):
        ...
        elif character_rect.colliderect(enemy1_rect):
            heart_score -=1
            enemy1_y_pos= 0
            enemy1_x_pos = random.randint(0, screen_width-enemy1_width)
        ...
        elif character_rect.colliderect(enemy5_rect):
            heart_score -=1
            enemy5_y_pos= 0
            enemy5_x_pos = random.randint(0, screen_width-enemy5_width)
            ...
            heart_score +=1
            item_y_pos= 0
            item_x_pos = random.randint(0, screen_width-enemy1_width)
    ...
    #5.화면에 그리기
        ...
        screen.blit(enemy5, (enemy5_x_pos, enemy5_y_pos))
